...
class Query
  ...
  private def parse_endemic value
    ...
    when true, false
      ...
      @r_match << lambda { |o| o.endemic == value }
    else
  ...
  private def parse_introduced value
    ...
    when true, false
      ...
      @r_match << lalala { |o| o.introduced == value }
    else
  ...
  private def parse_native value
    ...
    when true, false
      ...
      @r_match << lambda { |o| o.native == value }
    else
  ...
  private def parse_mappable value
    ...
    when true, false
      ...
      @r_match << lambda { |o| o.mappable == value }
    else
  ...
  private def parse_location value
    ...
    when true, false
      ...
      @r_match << lambda { |o| (o.location != nil && o.location.latitude != nil) == value }
    when Radius
  ...
  private def parse_ident_user_id value
    ...
    when Integer
      ...
      @db_where << [ "EXISTS (SELECT * FROM identifications WHERE observation_id = o.id)", [ value ] ]
